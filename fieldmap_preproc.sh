...
# in the BIDS root directory. The optional overwrite
# flag will overwrite any previously computed fieldmaps
...
#
# OUTPUT:
# - sub-<subjectid>_acq-b0mapsplit_run-<0?>_fieldmap.nii.gz
# - sub-<subjectid>_acq-b0mapsplit_run-<0?>_fieldmap.json
# - sub-<subjectid>_acq-b0mapsplit_run-<0?>_magnitude.nii.gz
